<!-- Generated: 2026-03-27 | Files scanned: 10 | Token estimate: ~600 -->
...
|-----|---------|---------|---------|
| Anthropic Claude | ANTHROPIC_API_KEY | claude_client.py | AI reasoning (temp=0.1, sonnet) |
...
Per-source: MOCK_CIVIC_API, MOCK_OPENFEC_API, MOCK_FL_FINANCE_API, MOCK_BALLOTPEDIA_API, MOCK_FL_ELECTIONS_API, MOCK_NEWSAPI, MOCK_LEGISLATION_API, MOCK_CLAUDE
